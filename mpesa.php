...
<?php    
    ...
    if(isset($_GET['messagez'])){
        $code_error_message = "";
    }else{
        $code_error_message = "* MPESA Code required to comlete transaction!";
    }
                ...
                <div class="row">
                    ...
                    <div class="col-md-12 ">
                        ...
                        <div class="row cart-product-details">
                            ...
                            <div class="col-sm-4 side-bars">                            
                                <ul>
                                    <li> Select MPESA From Safaricom Menu </li>
                            ...
                            <div class="col-sm-4 ">
                                <form method="POST" action="mpesa.php">
                                    ...
                                    <div class="input-controls"> 
                                        ...
                                        <div class="control"> 
                                            <input type="text" name="code"  placeholder="MPESA Code" class="input-text">
                                            <input type="text" name="company"  value="MPESA" hidden="true">
                                        </div>
