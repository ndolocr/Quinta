        ...
        if($product_name==""){
            ...
            $num_rows = mysqli_num_rows($result);
             ...
             $insert_query = "INSERT INTO product "
                    ."(productId, categoryId, productName, brand, size, color, productDescription, image )"
                    ."VALUES"
                    ."('$productId', '$category', '$product_name', '$brand', '$size', '$color', '$description', '$image')";
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-10 middle-box">                                         
                            ...
                            <div class="input-controls"> 
                                ...
                                <div class="control"> 
                                    <input type="text" id="stockAvailable" disabled class="input-text" value="10" >
                                </div>
                                <div class="first-name-error-message">
                            ...
                            <!--<div class="input-controls"> 
                                ...
                                <div class="control"> 
                                    <input type="text" name="discountAllowed"  placeholder="Discount Allowed" class="input-text">
                                </div>                                            
                                <div class="clear-float"></div>
                            </div>
                            <!-- END INPUT CONTROL -->
